...
The first version will check one studio's website and The Porn Database (TPDB) each day, reconcile records for scenes released in the past 90 days, and present one canonical list in a dashboard.

## First milestone

Prove the end-to-end workflow for a single studio:

1. Poll the studio's web portal and TPDB API daily.
...
Planning. The initial studio, implementation, and setup instructions have yet to be chosen; this README describes the intended first version rather than a working release.
